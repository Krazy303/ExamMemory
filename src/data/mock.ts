...
export const team = [
  {
    name: "Dr. Nia Okafor",
    role: "Co-founder & CEO",
    bio: "Former learning scientist at MIT.",
    avatar: "https://i.pravatar.cc/160?img=48",
  },
  {
    name: "Ravi Menon",
    role: "Co-founder & CTO",
    bio: "Built memory systems at DeepMind.",
    avatar: "https://i.pravatar.cc/160?img=13",
  },
  {
    name: "Sofia Vega",
    role: "Head of Product",
    bio: "Ex-Notion, obsessed with student workflows.",
    avatar: "https://i.pravatar.cc/160?img=44",
  },
  {
    name: "Kenji Ito",
    role: "Lead Designer",
    bio: "Design systems from Airbnb & Linear.",
